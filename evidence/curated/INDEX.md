...
| `03-replay-business-outcome` | replay | business_outcome | 10 | 0.5s | member_not_found: No member record matches the supplied member id. |
...
| `08-replay-validation-rejected` | replay | business_outcome | 10 | 12.1s | validation_rejected: The application rejected the submitted values and showed field errors. |
| `09-replay-session-expired` | replay | success | 0 | 0.2s | savings_balance=4182.55 |
| `10-replay-unexpected-dialog` | replay | needs_human | 20 | 0.5s | unknown_state, intervention 20260915-000324-efed-unknown_state-0 |
